...
## [1.6.2](https://github.com/siutsin/archey-osx/tree/1.6.2) (2020-08-01)

- Updated DNS resolver, use `dig OpenDNS` instead of `curl`.
- Fixed documentation format.

## [1.6.1](https://github.com/siutsin/archey-osx/tree/1.6.1) (2020-08-01)

Release the latest `master` branch code from the upstream repository.
